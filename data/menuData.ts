...
const RAW_MENU_CATEGORIES: MenuCategory[] = [
  ...
  },
  {
    ...
    hasSupplements: false,
    items: [
      { name: 'Pizza Classica (Margherita)', price: 8.50, unavailable: true },
      { name: 'Pizza Parma', price: 10.00, unavailable: true },
      { name: 'Pizza Bologna', price: 11.00, unavailable: true },
      { name: 'Pizza Végétarienne', price: 11.00, unavailable: true },
      { name: 'Pizza Tropicale', price: 11.00, unavailable: true },
      { name: 'Pizza Fondante', price: 11.50, unavailable: true },
      { name: 'Pizza Neptune', price: 11.50, unavailable: true },
      { name: 'Pizza Napolitaine', price: 11.50, unavailable: true },
      { name: 'Pizza Tunisiano', price: 12.00, unavailable: true },
      { name: 'Pizza Quattro Stagioni', price: 12.00, unavailable: true },
      { name: 'Pizza Fermière', price: 12.00, unavailable: true },
      { name: 'Pizza Texane', price: 12.00, unavailable: true },
      { name: 'Pizza Savoyarde', price: 13.00, unavailable: true },
      { name: 'Pizza Norvégienne', price: 13.00, unavailable: true },
      { name: 'Pizza Riviera', price: 13.00, unavailable: true },
      { name: 'Pizza Atlantica', price: 13.50, unavailable: true },
      { name: 'Pizza Mediterranée', price: 13.50, unavailable: true },
    ]
  },
  {
    id: 'boissons',
